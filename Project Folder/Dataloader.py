...
class DataImage(Dataset):
    def __init__(self, mode='train', flatten = False, small_dataset = False):
        #image_dir = path to folder of folders of images
        image_dir = r"C:\Users\Frede\bbbc021\singlecell\singh_cp_pipeline_singlecell_images"
...
if __name__ == "__main__":
    ...
    dataset = DataImage(flatten=False, small_dataset=True) # takes either .npy or .tiff files
